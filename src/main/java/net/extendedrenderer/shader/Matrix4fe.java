...
public class Matrix4fe {
    ...
    public float m23() { return this.m23; }
    public float m30() { return this.m30; }
    public float m31() { return this.m31; }
    public float m32() { return this.m32; }
    public float m33() { return this.m33; }

    void _m00(float m00) { this.m00 = m00; }
    void _m01(float m01) { this.m01 = m01; }
    void _m02(float m02) { this.m02 = m02; }
    void _m03(float m03) { this.m03 = m03; }
    void _m10(float m10) { this.m10 = m10; }
    void _m11(float m11) { this.m11 = m11; }
    void _m12(float m12) { this.m12 = m12; }
    void _m13(float m13) { this.m13 = m13; }
    void _m20(float m20) { this.m20 = m20; }
    void _m21(float m21) { this.m21 = m21; }
    void _m22(float m22) { this.m22 = m22; }
    void _m23(float m23) { this.m23 = m23; }
    void _m30(float m30) { this.m30 = m30; }
    void _m31(float m31) { this.m31 = m31; }
    void _m32(float m32) { this.m32 = m32; }
    void _m33(float m33) { this.m33 = m33; }
    ...
    private Matrix4fe rotateGeneric(float ang, float x, float y, float z, Matrix4fe dest) {
        ...
        dest._m00(nm00); dest._m01(nm01); dest._m02(nm02); dest._m03(nm03);
        dest._m10(nm10); dest._m11(nm11); dest._m12(nm12); dest._m13(nm13);
        dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
    ...
    public Matrix4fe rotation(float angle, float x, float y, float z) {
        ...
        this._m22(cos + z * z * C);
        this._m32(0.0F);
        this._m03(0.0F); this._m13(0.0F); this._m23(0.0F); this._m33(1.0F);
        this._properties(2);
        return this;
    }
    ...
    public Matrix4fe rotateTranslation(float ang, float x, float y, float z, Matrix4fe dest) {
        ...
        float rm10 = xy * C - z * s, rm11 = yy * C + c,   rm12 = yz * C + x * s;
        float rm20 = xz * C + y * s, rm21 = yz * C - x * s, rm22 = zz * C + c;
        dest._m20(rm20); dest._m21(rm21); dest._m22(rm22);
        dest._m00(rm00); dest._m01(rm01); dest._m02(rm02); dest._m03(0.0F);
        dest._m10(rm10); dest._m11(rm11); dest._m12(rm12); dest._m13(0.0F);
        dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
        dest._properties((byte) (this.properties & -14));
        return dest;
    }
    ...
    public Matrix4fe rotateAffine(float ang, float x, float y, float z, Matrix4fe dest) {
        ...
        dest._m22(this.m02 * rm20 + this.m12 * rm21 + this.m22 * rm22);
        dest._m23(0.0F);
        dest._m00(nm00); dest._m01(nm01); dest._m02(nm02); dest._m03(0.0F);
        dest._m10(nm10); dest._m11(nm11); dest._m12(nm12); dest._m13(0.0F);
        dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
        dest._properties((byte) (this.properties & -14));
        return dest;
    }
    ...
    public Matrix4fe rotateX(float ang, Matrix4fe dest) {
        if ((this.properties & 4) != 0) {
            ...
            dest._m10(nm10); dest._m11(nm11); dest._m12(nm12); dest._m13(nm13);
            dest._m00(this.m00); dest._m01(this.m01); dest._m02(this.m02); dest._m03(this.m03);
            dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
            dest._properties((byte) (this.properties & -14));
            return dest;
        }
    ...
    public Matrix4fe rotateY(float ang, Matrix4fe dest) {
        if ((this.properties & 4) != 0) {
            ...
            dest._m00(nm00); dest._m01(nm01); dest._m02(nm02); dest._m03(nm03);
            dest._m10(this.m10); dest._m11(this.m11); dest._m12(this.m12); dest._m13(this.m13);
            dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
            dest._properties((byte) (this.properties & -14));
            return dest;
        }
    ...
    public Matrix4fe rotateZ(float ang, Matrix4fe dest) {
        if ((this.properties & 4) != 0) {
            ...
            dest._m00(nm00); dest._m01(nm01); dest._m02(nm02); dest._m03(nm03);
            dest._m20(this.m20); dest._m21(this.m21); dest._m22(this.m22); dest._m23(this.m23);
            dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
            dest._properties((byte) (this.properties & -14));
            return dest;
        }
    ...
    public Matrix4fe scaling(float x, float y, float z) {
        identity(this);
        this._m00(x); this._m11(y); this._m22(z);
        this._properties(2);
        return this;
    }

    private Matrix4fe scaleGeneric(float x, float y, float z, Matrix4fe dest) {
        dest._m00(this.m00 * x); dest._m01(this.m01 * x); dest._m02(this.m02 * x); dest._m03(this.m03 * x);
        dest._m10(this.m10 * y); dest._m11(this.m11 * y); dest._m12(this.m12 * y); dest._m13(this.m13 * y);
        dest._m20(this.m20 * z); dest._m21(this.m21 * z); dest._m22(this.m22 * z); dest._m23(this.m23 * z);
        dest._m30(this.m30); dest._m31(this.m31); dest._m32(this.m32); dest._m33(this.m33);
        dest._properties((byte) (this.properties & -14));
        return dest;
    }
    ...
    public final Matrix4fe identity(Matrix4fe dest) {
        dest.m00 = 1.0F; dest.m01 = 0.0F; dest.m02 = 0.0F; dest.m03 = 0.0F;
        dest.m10 = 0.0F; dest.m11 = 1.0F; dest.m12 = 0.0F; dest.m13 = 0.0F;
    ...
    public final void zero(Matrix4fe dest) {
        dest.m00 = 0.0F; dest.m01 = 0.0F; dest.m02 = 0.0F; dest.m03 = 0.0F;
        dest.m10 = 0.0F; dest.m11 = 0.0F; dest.m12 = 0.0F; dest.m13 = 0.0F;
        dest.m20 = 0.0F; dest.m21 = 0.0F; dest.m22 = 0.0F; dest.m23 = 0.0F;
        dest.m30 = 0.0F; dest.m31 = 0.0F; dest.m32 = 0.0F; dest.m33 = 0.0F;
    }
    ...
    private void putN(int offset, FloatBuffer dest) {
        dest.put(offset,      m00); dest.put(offset + 1,  m01);
        dest.put(offset + 2,  m02); dest.put(offset + 3,  m03);
        dest.put(offset + 4,  m10); dest.put(offset + 5,  m11);
        dest.put(offset + 6,  m12); dest.put(offset + 7,  m13);
        dest.put(offset + 8,  m20); dest.put(offset + 9,  m21);
        dest.put(offset + 10, m22); dest.put(offset + 11, m23);
        dest.put(offset + 12, m30); dest.put(offset + 13, m31);
        dest.put(offset + 14, m32); dest.put(offset + 15, m33);
    }

    private void put0(FloatBuffer dest) {
        dest.put(0,  m00); dest.put(1,  m01); dest.put(2,  m02); dest.put(3,  m03);
        dest.put(4,  m10); dest.put(5,  m11); dest.put(6,  m12); dest.put(7,  m13);
        dest.put(8,  m20); dest.put(9,  m21); dest.put(10, m22); dest.put(11, m23);
        dest.put(12, m30); dest.put(13, m31); dest.put(14, m32); dest.put(15, m33);
    }
    ...
    public Matrix4fe translation(float x, float y, float z) {
        identity(this);
        this._m30(x); this._m31(y); this._m32(z);
        this._properties(10);
        return this;
    }
    ...
    private Matrix4fe mulGeneric(Matrix4fe right, Matrix4fe dest) {
        ...
        dest._m00(nm00); dest._m01(nm01); dest._m02(nm02); dest._m03(nm03);
        dest._m10(nm10); dest._m11(nm11); dest._m12(nm12); dest._m13(nm13);
        dest._m20(nm20); dest._m21(nm21); dest._m22(nm22); dest._m23(nm23);
        dest._m30(nm30); dest._m31(nm31); dest._m32(nm32); dest._m33(nm33);
        dest._properties(0);
        return dest;
    }
    ...
    public Matrix4fe transpose3x3(Matrix4fe dest) {
        ...
        dest._m00(nm00); dest._m01(nm01); dest._m02(nm02);
        dest._m10(nm10); dest._m11(nm11); dest._m12(nm12);
        dest._m20(nm20); dest._m21(nm21); dest._m22(nm22);
        dest._properties(0);
        return dest;
    }
    ...
    public Matrix4fe translationRotateScale(
        ...
        this._m00(sx - (q11 + q22) * sx); this._m01((q01 + q23) * sx);        this._m02((q02 - q13) * sx);        this._m03(0.0F);
        this._m10((q01 - q23) * sy);       this._m11(sy - (q22 + q00) * sy);   this._m12((q12 + q03) * sy);        this._m13(0.0F);
        this._m20((q02 + q13) * sz);       this._m21((q12 - q03) * sz);        this._m22(sz - (q11 + q00) * sz);   this._m23(0.0F);
        this._m30(tx); this._m31(ty); this._m32(tz); this._m33(1.0F);
        this._properties(2);
        return this;
    }
