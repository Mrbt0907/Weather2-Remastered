...
public class ItemSandLayer extends ItemBlockBetter
{
    ...
    public boolean canPlaceBlockOnSide(World world, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack)
    {
        ...
        return (state.getBlock() != BlockRegistry.sand_layer || ((Integer)state.getValue(BlockSandLayer.LAYERS)) > 7) ? super.canPlaceBlockOnSide(world, pos, side, player, stack) : true;
    }
}