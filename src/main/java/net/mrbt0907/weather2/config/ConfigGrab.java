...
public class ConfigGrab implements IConfigEX {
    @Enforce
    @Comment("Should weather2 use math functions that are far more accurate? Enabling this option will ensure rotations happen properly at the cost of fps.")
    ...
    public static boolean grab_list_partial_match = false;
    @Enforce
    ...
    public static boolean replace_list_partial_match = false;
    @Enforce
    ...
    public static boolean entity_blacklist_partial_match = false;
    @Enforce
