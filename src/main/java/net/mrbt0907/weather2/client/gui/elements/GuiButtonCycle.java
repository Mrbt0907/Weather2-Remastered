...
public class GuiButtonCycle extends GuiButton
{
    ...
    public GuiButtonCycle(int par1, int par2, int par3, int par4, int par5, List<String> parEntries, int parDefaultIndex) throws Exception
    {
        ...
        if (parEntries == null)
        	Weather2.fatal("Entries returned null with button id:" + par1);
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3, float partialTicks)
    {
        if (this.visible)
        {
            ...
            str = new TextComponentTranslation("config.ezgui." + getDisplayString()).getFormattedText();
