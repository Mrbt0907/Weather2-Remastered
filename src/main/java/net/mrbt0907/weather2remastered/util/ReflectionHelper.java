<<<<<<< Updated upstream:src/main/java/net/mrbt0907/weather2remastered/util/ReflectionHelper.java
package net.mrbt0907.weather2remastered.util;
=======
package net.mrbt0907.weather2.util;
>>>>>>> Stashed changes:src/main/java/net/mrbt0907/weather2/util/ReflectionHelper.java
...
public class ReflectionHelper
{
	...
	public static Field getField(Class <?> clazz, String fieldName, String fieldObfName)
	{
		...
		if (field == null)
		{
			String name = !net.minecraftforge.fml.loading.FMLEnvironment.production ? fieldName : MoreObjects.firstNonNull(fieldObfName, fieldName);
			try
			{
